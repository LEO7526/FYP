...
<div class="container">
    ...
    <div class="menu-buttons">
        <a href="newCoupon.php" class="menu-btn coupon-btn">Create New Coupon</a>
        <a href="newDishes.php" class="menu-btn dish-btn">Add New Dish</a>
        <a href="newPackage.php" class="menu-btn package-btn">Create New Package</a>
    </div>
</div>
