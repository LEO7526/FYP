...
$targetDir = dirname(__DIR__, 2) . DIRECTORY_SEPARATOR . 'Image' . DIRECTORY_SEPARATOR . 'Profile_image' . DIRECTORY_SEPARATOR . 'Staff';
...
if (!$stmt->execute()) {
    ...
    echo json_encode([
        'success' => false,
        'status' => 'error',
        'message' => 'Failed to update staff image path'
    ]);
    exit;
}
