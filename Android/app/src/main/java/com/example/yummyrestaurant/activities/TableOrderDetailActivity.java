...
public class TableOrderDetailActivity extends ThemeBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tableTitle.setText(getString(R.string.table_order_number, tableOrderId));

        if (orderId != -1) {
            fetchOrderItems(orderId);
        } else {
            Toast.makeText(this, R.string.invalid_order_id, Toast.LENGTH_SHORT).show();
        }
    }
        ...
        call.enqueue(new Callback<List<OrderItem>>() {
            ...
            public void onResponse(Call<List<OrderItem>> call, Response<List<OrderItem>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    Toast.makeText(TableOrderDetailActivity.this, R.string.failed_load_order_items, Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<List<OrderItem>> call, Throwable t) {
                ...
                Toast.makeText(TableOrderDetailActivity.this,
    ...
    private void displayOrderItems(List<OrderItem> items) {
        ...
        totalCostText.setText(getString(R.string.total_hkd, String.format("%.2f", total)));
    }
}
