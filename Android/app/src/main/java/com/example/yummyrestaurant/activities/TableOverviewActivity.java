    ...
    private void fetchTableOrders() {
        ...
        call.enqueue(new Callback<List<TableOrder>>() {
            ...
            public void onResponse(Call<List<TableOrder>> call, Response<List<TableOrder>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    tableGridView.setOnItemClickListener((parent, view, position, id) -> {
                        ...
                        switch (status) {
                            case "available":
                                Toast.makeText(TableOverviewActivity.this, R.string.table_available_no_action, Toast.LENGTH_SHORT).show();
                                break;
                            case "reserved":
                                Toast.makeText(TableOverviewActivity.this, R.string.table_reserved_waiting, Toast.LENGTH_SHORT).show();
                                break;
                            case "seated":
                                Toast.makeText(TableOverviewActivity.this, R.string.guests_seated_ready_order, Toast.LENGTH_SHORT).show();
                                break;
                            default:
                    ...
                    Toast.makeText(TableOverviewActivity.this, R.string.failed_load_tables, Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<List<TableOrder>> call, Throwable t) {
                ...
                Toast.makeText(TableOverviewActivity.this,
