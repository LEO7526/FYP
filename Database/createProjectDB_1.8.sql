...
INSERT INTO customer (
  cid, cname, cpassword, ctel, caddr, company, cemail, crole
) VALUES (
  0, 'Walk-in Customer', 'walkin', NULL, NULL, NULL, 'walkin@system.local', 'customer'
);
...
(4, 42.00, 'https://raw.githubusercontent.com/LEO7526/FYP/main/Website/Staff/SampleImages/dish/MapoTofu.jpg', 'Spicy', 'tofu,beef,numbing', TRUE),
(4, 38.00, 'https://raw.githubusercontent.com/LEO7526/FYP/main/Website/Staff/SampleImages/dish/DanDanNoodles.jpg', 'Hot', 'noodles,pork,streetfood', TRUE),
(4, 88.00, 'https://raw.githubusercontent.com/LEO7526/FYP/main/Website/Staff/SampleImages/dish/TwiceCookedPork.jpg', 'Medium', 'pork,stirfry,classic', TRUE);

-- Insert translation for dishes
...
(3, 'en', 'Mapo Tofu', 'Silken tofu in spicy bean paste sauce with minced beef and numbing Sichuan peppercorns.'),
(3, 'zh-CN', '麻婆豆腐', '嫩豆腐配牛肉末和麻辣豆瓣酱，风味十足。'),
(3, 'zh-TW', '麻婆豆腐', '嫩豆腐搭配牛肉末與麻辣豆瓣醬，風味十足。'),
(4, 'en', 'Dan Dan Noodles', 'Spicy noodles topped with minced pork, preserved vegetables, and chili oil.'),
(4, 'zh-CN', '担担面', '辣味面条配猪肉末、芽菜和红油，香辣诱人。'),
(4, 'zh-TW', '擔擔麵', '辣味麵條搭配豬肉末、芽菜與紅油，香辣誘人。'),
(5, 'en', 'Twice-Cooked Pork', 'Pork belly simmered then stir-fried with leeks and chili bean paste for a rich, savory flavor.'),
(5, 'zh-CN', '回锅肉', '五花肉先煮后炒，搭配蒜苗和豆瓣酱，香浓可口。'),
(5, 'zh-TW', '回鍋肉', '五花肉先煮後炒，搭配蒜苗與豆瓣醬，香濃可口。');
