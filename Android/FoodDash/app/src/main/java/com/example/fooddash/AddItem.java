...
public class AddItem extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            final EditText restaurantId = (EditText) findViewById(R.id.restaurantIdInput);
            restaurantId.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    restaurantId.setText("", TextView.BufferType.EDITABLE);
                }
            });
            ...
            submit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // your handler code here
                    if(!confirmInput(deliveryCharges,deliveryTime,imageUrl,foodName,foodNote,foodPrice,foodRating,foodType,restaurantId))
                    ...
                    else
                    {
                        ...
                        Food f = new Food(
                                ...
                                deliverytime,
                                deliverycharge,
                                foodNote.getText().toString(),
                                imageUrl.getText().toString(),
                                restaurantId.getText().toString()
                        );
        ...
        public boolean confirmInput(EditText deliveryCharges, EditText deliveryTime, EditText imageUrl,
                                    EditText foodName, EditText foodNote, EditText foodPrice,
                                    EditText foodRating, EditText foodType, EditText restaurantId)
        {
            ...
            if (restaurantId.getText().toString().equals("")) {
                restaurant = false;
                restaurantId.setError("Input is Empty");
            }

            return charges && time && url && name && note && price && rating && type && restaurant;
        }
