...
<div class="container">
    ...
    <form id="productForm" method="post" action="insertItemsProcess.php" enctype="multipart/form-data">
        <div class="form-group">
            <h2 class="form-label">Product Name</h2>
            <input type="text" id="productName" name="productName" required>
        </div>
        <div class="form-group">
            <h2 class="form-label">Product Description</h2>
            <textarea id="productDescription" name="productDescription" required></textarea>
        </div>
        <div class="form-group">
            <h2 class="form-label">Product Cost (USD)</h2>
        ...
        <div class="form-group">
            <h2 class="form-label">Product Image</h2>
