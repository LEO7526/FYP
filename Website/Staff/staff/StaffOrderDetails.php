...
<div class="order-details-container">
    <div class="back-link">
        <a href="bookingList.php" class="back-link-text"> &#60; Back to Order List</a>
    </div>
    ...
    <div class="order-grid">
        ...
        <div class="card">
            ...
            <div class="info-grid">
                ...
                <div class="info-item">
                    <div class="info-label">XXXXX</div>
        ...
        <div class="card">
            <div class="card-header">
                <h2 class="card-title">Sales Information</h2>
            </div>
            <div class="info-grid">
                <div class="info-item">
                    <div class="info-label">XXXXX</div>
        ...
        <div class="card">
            <div class="card-header">
                <h2 class="card-title">Material  Information</h2>
            </div>
            <div class="info-grid">
                <div class="info-item">
                    <div class="info-label">XXXXX</div>
    ...
    <div class="order-actions">
        <?php if ($order['ostatus'] == 1 || $order['ostatus'] == 2): ?>
            <a href="bookingStatus.php?oid=<?= $oid ?>&action=accept" class="btn-accept">Accept</a>
            <a href="bookingStatus.php?oid=<?= $oid ?>&action=reject" class="btn-reject">Reject</a>
