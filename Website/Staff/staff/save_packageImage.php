...
$githubToken = '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';
$repoOwner = 'LEO7526';
$repoName = 'FYP';
$branch = 'main';
...
if (!isset($_FILES['packageImage']) || $_FILES['packageImage']['error'] !== UPLOAD_ERR_OK) {
    $errorCode = $_FILES['packageImage']['error'] ?? 'undefined';
...
$uploadedFile = $_FILES['packageImage'];
...
try {
    ...
    // Prepare upload data
    $postData = [
        'message' => 'Upload package image: ' . $fileName,
        'content' => $fileContent,
        'branch' => $branch
    ];
