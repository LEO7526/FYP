...
(1, 'zh-CN', '10 Percent Off', 'Get 10 percent discount on your next order.'),
(1, 'zh-TW', '10 Percent Off', 'Get 10 percent discount on your next order.'),
(2, 'en', 'Free Drink', 'Redeem one free drink of your choice.'),
(2, 'zh-CN', 'Free Drink', 'Redeem one free drink of your choice.'),
(2, 'zh-TW', 'Free Drink', 'Redeem one free drink of your choice.'),
(3, 'en', 'HK$50 OFF', 'Enjoy HK$50 off when you spend HK$300 or more.'),
(3, 'zh-CN', 'HK$50 OFF', 'Enjoy HK$50 off when you spend HK$300 or more.'),
(3, 'zh-TW', 'HK$50 OFF', 'Enjoy HK$50 off when you spend HK$300 or more.'),
(4, 'en', 'Birthday Special', 'Exclusive coupon for your birthday month.'),
(4, 'zh-CN', 'Birthday Special', 'Exclusive coupon for your birthday month.'),
(4, 'zh-TW', 'Birthday Special', 'Exclusive coupon for your birthday month.');
...
(1, 'zh-TW', '優惠券不可兌換現金、信用額或其他產'),
(2, 'zh-TW', '優惠券不可兌換現金、信用額或其他產'),
(3, 'zh-TW', '優惠券不可兌換現金、信用額或其他產'),
(4, 'zh-TW', '優惠券不可兌換現金、信用額或其他產'),
...
(1, 'zh-CN', '优惠券不可兑换现金、信用额或其他产'),
(2, 'zh-CN', '优惠券不可兑换现金、信用额或其他产'),
(3, 'zh-CN', '优惠券不可兑换现金、信用额或其他产'),
(4, 'zh-CN', '优惠券不可兑换现金、信用额或其他产'),
...
(5, 'zh-CN', '重庆风味安格斯牛', '辣味安格斯牛肉配豆瓣酱和香茅，麻辣持久'),
(5, 'zh-TW', '重慶風味安格斯牛', '辣味安格斯牛肉搭配豆瓣醬與香茅，麻辣持久'),
...
(7, 'zh-CN', '担担', '辣味面条配猪肉末、芽菜和红油，香辣诱人'),
(7, 'zh-TW', '擔擔', '辣味麵條搭配豬肉末、芽菜與紅油，香辣誘人'),
(8, 'en', 'Twice-Cooked Pork', 'Pork belly simmered then stir-fried with leeks and chili bean paste.'),
(8, 'zh-CN', '回锅', '五花肉先煮后炒，搭配蒜苗和豆瓣酱，香浓可口'),
(8, 'zh-TW', '回鍋', '五花肉先煮後炒，搭配蒜苗與豆瓣醬，香濃可口'),
...
(11, 'zh-CN', '四川糯米', '糯米糕配红糖和芝麻，甜而不腻'),
(11, 'zh-TW', '四川糯米', '糯米糕搭配紅糖與芝麻，甜而不膩'),
...
INSERT INTO materials (mname, category_id, unit, mqty, reorderLevel) VALUES
('Chili Powder', 3, 'grams', 80.00, 100.00),      -- 庫存80g，低於重新訂購水00g
('Garlic', 1, 'grams', 800.00, 300.00),           -- 庫存800g，高於重新訂購水00g
('Ginger', 1, 'grams', 60.00, 150.00),            -- 庫存60g，低於重新訂購水50g
('Soy Sauce', 3, 'ml', 1200.00, 500.00),          -- 庫存1200ml，高於重新訂購水00ml
('Rice Vinegar', 3, 'ml', 900.00, 400.00);        -- 庫存900ml，高於重新訂購水00ml
...
(32, 'zh-CN', '芝麻', '油炸糯米球，内馅是甜红豆沙'),
(32, 'zh-TW', '芝麻', '油炸糯米球，內餡是甜紅豆沙');
...
(128, 31, 1),
(128, 36, 1),
(128, 39, 1); -- 蔬菜春卷 + 芒果布丁 + 四川海鮮乾鍋 + 冰蜂蜜檸
-- =================================================================
-- =================================================================
...
-- =================================================================
-- Staff demo seed for 2026-04-29 and 2026-04-30
-- Covers: Kitchen Orders, Table Management, Cash Payment, Takeaway Cash,
-- Inventory Management and Inventory History demonstrations.
-- =================================================================

INSERT INTO orders (oid, odate, cid, ostatus, note, orderRef, coupon_id, order_type, table_number, payment_method) VALUES
(276, '2026-04-29 12:10:00', 1, 1, 'Staff demo kitchen order (new)', 'staff_demo_kitchen_new_20260429', NULL, 'dine_in', 9, 'card'),
(277, '2026-04-29 12:25:00', 2, 2, 'Staff demo kitchen order (cooking)', 'staff_demo_kitchen_cooking_20260429', NULL, 'dine_in', 12, 'card'),
(278, '2026-04-30 12:40:00', 3, 3, 'Staff demo kitchen order (delivered)', 'staff_demo_kitchen_done_20260430', NULL, 'dine_in', 15, 'card'),
(279, '2026-04-30 18:05:00', 0, 1, 'Staff demo kitchen takeaway order', 'staff_demo_kitchen_takeaway_20260430', NULL, 'takeaway', NULL, 'card'),
(280, '2026-04-29 19:00:00', 1, 0, 'Staff demo pending dine-in cash payment', 'staff_demo_cash_dinein_pending_20260429', NULL, 'dine_in', 18, 'cash'),
(281, '2026-04-30 19:20:00', 0, 0, 'Staff demo pending dine-in cash payment', 'staff_demo_cash_dinein_pending_20260430', NULL, 'dine_in', 22, 'cash'),
(282, '2026-04-29 20:05:00', 2, 0, 'Staff demo pending takeaway cash payment', 'staff_demo_cash_takeaway_pending_20260429', NULL, 'takeaway', NULL, 'cash'),
(283, '2026-04-30 12:15:00', 4, 1, 'Staff demo completed takeaway cash payment', 'staff_demo_cash_takeaway_done_20260430', NULL, 'takeaway', NULL, 'cash'),
(284, '2026-04-29 13:45:00', 5, 1, 'Staff demo completed takeaway cash payment', 'staff_demo_cash_takeaway_done_20260429', NULL, 'takeaway', NULL, 'cash'),
(285, '2026-04-30 20:40:00', 0, 0, 'Staff demo pending takeaway cash payment', 'staff_demo_cash_takeaway_pending_20260430', NULL, 'takeaway', NULL, 'cash');
...
INSERT INTO booking (cid, bkcname, bktel, tid, bdate, btime, pnum, purpose, remark, status) VALUES
(1, 'Staff Demo Reserved 429', 95550101, 9, '2026-04-29', '19:00:00', 4, 'Teacher Demo', 'Reserved example for table management demo', 1),
(2, 'Staff Demo CheckedIn 429', 95550102, 18, '2026-04-29', '19:30:00', 2, 'Teacher Demo', 'Checked-in example for table management demo', 2),
(3, 'Staff Demo Reserved 430', 95550103, 22, '2026-04-30', '18:30:00', 6, 'Teacher Demo', 'Reserved example for next-day table demo', 1),
(4, 'Staff Demo CheckedIn 430', 95550104, 6, '2026-04-30', '12:00:00', 3, 'Teacher Demo', 'Checked-in example for next-day table demo', 2);

INSERT INTO consumption_history (mid, log_date, log_type, details) VALUES
(1, '2026-04-29', 'Deduction', 'Demo deduction for cucumber from staff test orders'),
(2, '2026-04-29', 'Forecast', 'Demo forecast for chicken demand before dinner peak'),
(5, '2026-04-30', 'Reorder', 'Demo reorder trigger for rice to restock threshold'),
(7, '2026-04-30', 'Deduction', 'Demo deduction for tofu from kitchen production run');
