...
public class StaffOrdersActivity extends StaffBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emptyStateText = findViewById(R.id.tvEmptyOrders);
        refreshOrdersButton = findViewById(R.id.btnRefreshOrders);
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                // Tab 0 = New(1), Tab 1 = Making(2), Tab 2 = Delivered(3)
        ...
        Toast.makeText(this,
            getString(R.string.logged_in_as, session.getStaffName()),
    ...
    private void setupNavigationDrawer() {
        ...
        if (hamburgerMenu != null) {
            hamburgerMenu.setOnClickListener(v -> {
                Toast.makeText(this, R.string.opening_drawer, Toast.LENGTH_SHORT).show();
        ...
        if (headerView != null) {
            ...
            if (staffRole != null) {
                staffRole.setText(R.string.kitchen_staff_role);
            }
        }
    }
                    ...
                    try {
                        ...
                        if (jsonObject.getString("status").equals("success")) {
                            ...
                            if (allOrderList.isEmpty()) {
                                showEmptyState(getString(R.string.unable_load_orders_tap_refresh));
                            }
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                        Toast.makeText(this,
                                getString(R.string.data_error_prefix, e.getMessage()),
                                Toast.LENGTH_SHORT).show();
                        if (allOrderList.isEmpty()) {
                            showEmptyState(getString(R.string.unable_parse_orders_tap_refresh));
                        }
                    }
                },
                error -> {
                    ...
                    String msg = error.getMessage() != null ? error.getMessage() : getString(R.string.unknown_network_error);
                    Toast.makeText(this,
                            getString(R.string.network_error_prefix, msg),
                            Toast.LENGTH_SHORT).show();
                    if (allOrderList.isEmpty()) {
                        showEmptyState(getString(R.string.network_issue_tap_refresh));
                    }
                }
        );
    ...
    private void updateTabCounts() {
        ...
        for (StaffOrder order : allOrderList) {
            ...
            if (order.getStatus() == 1) {
                countNew++;
                android.util.Log.d("KitchenOrders", "Counted for New tab");
            } else if (order.getStatus() == 2) {
                countMaking++;
                android.util.Log.d("KitchenOrders", "Counted for Making tab");
        ...
        if (tabLayout.getTabAt(0) != null) tabLayout.getTabAt(0).setText(getString(R.string.new_count, countNew));
        if (tabLayout.getTabAt(1) != null) tabLayout.getTabAt(1).setText(getString(R.string.making_count, countMaking));
        if (tabLayout.getTabAt(2) != null) tabLayout.getTabAt(2).setText(getString(R.string.delivered_count, countDelivered));
    ...
    private void showEmptyStateIfNeeded() {
        if (displayOrderList.isEmpty()) {
            showEmptyState(getString(R.string.no_orders_in_this_tab));
        } else {
    ...
    private boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_orders) {
            ...
            startActivity(new Intent(StaffOrdersActivity.this, BookingManagementActivity.class));
            return true;
    ...
    private void showLanguageDialog() {
        ...
        final String[] codes = {"zh-TW", "zh-CN", "en"};

        String current = LanguageManager.getLangCode(this);
        int checked = 0;
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(R.string.confirm, (dialog, which) -> {
                    String newCode = codes[selected[0]];
                    if (!newCode.equals(LanguageManager.getLangCode(this))) {
                        LanguageManager.setLangCode(this, newCode);
                        recreate();
                    }
                })
