...
public class CashPaymentTableAdapter extends RecyclerView.Adapter<CashPaymentTableAdapter.TableViewHolder> {
    ...
    private static final int COLOR_CASH_COMPLETED = Color.parseColor("#2E7D32");
    ...
    public void onBindViewHolder(@NonNull TableViewHolder holder, int position) {
        ...
        holder.tableContainer.setOnClickListener(clickListener);
    }
    ...
    class TableViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(CashPaymentTable table) {
            ...
            drawable.setColor(table.isCompleted() ? COLOR_CASH_COMPLETED : COLOR_CASH_PENDING);
