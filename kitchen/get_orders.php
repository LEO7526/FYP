<?php
// get_orders.php
// API endpoint to fetch orders for kitchen display system
// Returns only pending orders (status=1) with items and customizations
...
try {
    ...
    $query = "
        ...
        FROM orders o
        WHERE o.ostatus = 1  -- Only show pending orders
