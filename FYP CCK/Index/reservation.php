            ...
            fetch("../booking/available_tables.php", {
                ...
                .then(data => {
                    ...
                    if (data.length === 0) {
                        ...
                        data.forEach(table => {
                            const div = $("<div>").addClass("table").text(`T${table.tid}`);
            ...
            loadBtn.addEventListener("click", function () {
                ...
                fetch("../booking/available_tables.php", {
                    ...
                    .then(data => {
                        ...
                        tableMap.innerHTML = ""; // 清空

                        if (data.length === 0) {
                            tableMap.innerHTML = "<p>No tables available</p>";
                        } else {
                            data.forEach(table => {
                                const div = document.createElement("div");
                                div.classList.add("table");
                                div.textContent = `T${table.tid}`;
                    ...
                    .catch(error => {
                        console.error("Failed to load tables:", error);
                        document.getElementById("table-map").innerHTML = "<p>Error loading tables</p>";
                    });
            });
        });
...
<div class="reservation-section">
    ...
    <div id="bookingForm" style="display:none;">
        ...
        <form method="post" action="../booking/booking.php" class="reservation-form">
            ...
            <div id="table-map" class="table-map"></div>
