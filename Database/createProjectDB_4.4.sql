...
(200, 'cash', 5000, NULL, '2025-12-31', 1),
...
CREATE TABLE IF NOT EXISTS order_item_customizations (
  ...
  option_id INT NOT NULL,
  option_name VARCHAR(255) NOT NULL,
  choice_ids JSON DEFAULT NULL,
  choice_names JSON DEFAULT NULL,
...
INSERT INTO item_customization_options (item_id, option_name, max_selections) VALUES
(1, 'Spice Level', 1), (1, 'Special Requests', 1),
(2, 'Spice Level', 1), (2, 'Special Requests', 1),
(3, 'Spice Level', 1), (3, 'Special Requests', 1),
(4, 'Spice Level', 1), (4, 'Special Requests', 1),
(5, 'Spice Level', 1), (5, 'Special Requests', 1),
(6, 'Spice Level', 1), (6, 'Special Requests', 1),
(7, 'Spice Level', 1), (7, 'Special Requests', 1),
(8, 'Spice Level', 1), (8, 'Special Requests', 1),
(9, 'Spice Level', 1), (9, 'Special Requests', 1),
(10, 'Spice Level', 1), (10, 'Special Requests', 1),
(11, 'Toppings', 3),
(12, 'Sugar Level', 1), (12, 'Ice Level', 1),
(13, 'Sugar Level', 1), (13, 'Ice Level', 1),
(14, 'Sugar Level', 1), (14, 'Milk', 1),
(15, 'Sugar Level', 1), (15, 'Ice Level', 1),
(16, 'Sugar Level', 1),
(17, 'Sugar Level', 1), (17, 'Milk', 1), (17, 'Ice Level', 1),
(18, 'Sugar Level', 1), (18, 'Ice Level', 1);

-- Spice Level Choices (Items 1-10)
INSERT INTO customization_option_choices (option_id, choice_name, additional_cost, display_order) 
SELECT option_id, choice_name, additional_cost, display_order
FROM (
  SELECT 1 AS option_id, 'Mild' AS choice_name, 0 AS additional_cost, 1 AS display_order UNION ALL
  SELECT 1, 'Medium', 0, 2 UNION ALL
  SELECT 1, 'Hot', 0, 3 UNION ALL
  SELECT 1, 'Numbing', 0, 4 UNION ALL
  SELECT 3, 'Mild', 0, 1 UNION ALL
  SELECT 3, 'Medium', 0, 2 UNION ALL
  SELECT 3, 'Hot', 0, 3 UNION ALL
  SELECT 3, 'Numbing', 0, 4 UNION ALL
  SELECT 5, 'Mild', 0, 1 UNION ALL
  SELECT 5, 'Medium', 0, 2 UNION ALL
  SELECT 5, 'Hot', 0, 3 UNION ALL
  SELECT 5, 'Numbing', 0, 4 UNION ALL
  SELECT 7, 'Mild', 0, 1 UNION ALL
  SELECT 7, 'Medium', 0, 2 UNION ALL
  SELECT 7, 'Hot', 0, 3 UNION ALL
  SELECT 7, 'Numbing', 0, 4 UNION ALL
  SELECT 9, 'Mild', 0, 1 UNION ALL
  SELECT 9, 'Medium', 0, 2 UNION ALL
  SELECT 9, 'Hot', 0, 3 UNION ALL
  SELECT 9, 'Numbing', 0, 4 UNION ALL
  SELECT 11, 'Mild', 0, 1 UNION ALL
  SELECT 11, 'Medium', 0, 2 UNION ALL
  SELECT 11, 'Hot', 0, 3 UNION ALL
  SELECT 11, 'Numbing', 0, 4 UNION ALL
  SELECT 13, 'Mild', 0, 1 UNION ALL
  SELECT 13, 'Medium', 0, 2 UNION ALL
  SELECT 13, 'Hot', 0, 3 UNION ALL
  SELECT 13, 'Numbing', 0, 4 UNION ALL
  SELECT 15, 'Mild', 0, 1 UNION ALL
  SELECT 15, 'Medium', 0, 2 UNION ALL
  SELECT 15, 'Hot', 0, 3 UNION ALL
  SELECT 15, 'Numbing', 0, 4 UNION ALL
  SELECT 17, 'Mild', 0, 1 UNION ALL
  SELECT 17, 'Medium', 0, 2 UNION ALL
  SELECT 17, 'Hot', 0, 3 UNION ALL
  SELECT 17, 'Numbing', 0, 4 UNION ALL
  SELECT 19, 'Mild', 0, 1 UNION ALL
  SELECT 19, 'Medium', 0, 2 UNION ALL
  SELECT 19, 'Hot', 0, 3 UNION ALL
  SELECT 19, 'Numbing', 0, 4
) t;

-- Sugar Level Choices (Items 12, 13, 14, 15, 16, 17, 18)
-- Hot drinks: More Sweet, Less Sweet, No Sweet
-- Cold drinks: More Sweet, Less Sweet, No Sweet
INSERT INTO customization_option_choices (option_id, choice_name, additional_cost, display_order)
SELECT option_id, choice_name, additional_cost, display_order
FROM (
  SELECT 22 AS option_id, 'More Sweet' AS choice_name, 0 AS additional_cost, 1 AS display_order UNION ALL
  SELECT 22, 'Less Sweet', 0, 2 UNION ALL
  SELECT 22, 'No Sweet', 0, 3 UNION ALL
  SELECT 24, 'More Sweet', 0, 1 UNION ALL
  SELECT 24, 'Less Sweet', 0, 2 UNION ALL
  SELECT 24, 'No Sweet', 0, 3 UNION ALL
  SELECT 26, 'More Sweet', 0, 1 UNION ALL
  SELECT 26, 'Less Sweet', 0, 2 UNION ALL
  SELECT 26, 'No Sweet', 0, 3 UNION ALL
  SELECT 28, 'More Sweet', 0, 1 UNION ALL
  SELECT 28, 'Less Sweet', 0, 2 UNION ALL
  SELECT 28, 'No Sweet', 0, 3 UNION ALL
  SELECT 30, 'More Sweet', 0, 1 UNION ALL
  SELECT 30, 'Less Sweet', 0, 2 UNION ALL
  SELECT 30, 'No Sweet', 0, 3 UNION ALL
  SELECT 32, 'More Sweet', 0, 1 UNION ALL
  SELECT 32, 'Less Sweet', 0, 2 UNION ALL
  SELECT 32, 'No Sweet', 0, 3 UNION ALL
  SELECT 34, 'More Sweet', 0, 1 UNION ALL
  SELECT 34, 'Less Sweet', 0, 2 UNION ALL
  SELECT 34, 'No Sweet', 0, 3
) t;

-- Ice Level Choices (Items 12, 13, 15, 17, 18 - cold drinks only, NO hot drinks)
-- More Ice, Less Ice, No Ice
INSERT INTO customization_option_choices (option_id, choice_name, additional_cost, display_order)
SELECT option_id, choice_name, additional_cost, display_order
FROM (
  SELECT 23 AS option_id, 'More Ice' AS choice_name, 0 AS additional_cost, 1 AS display_order UNION ALL
  SELECT 23, 'Less Ice', 0, 2 UNION ALL
  SELECT 23, 'No Ice', 0, 3 UNION ALL
  SELECT 25, 'More Ice', 0, 1 UNION ALL
  SELECT 25, 'Less Ice', 0, 2 UNION ALL
  SELECT 25, 'No Ice', 0, 3 UNION ALL
  SELECT 29, 'More Ice', 0, 1 UNION ALL
  SELECT 29, 'Less Ice', 0, 2 UNION ALL
  SELECT 29, 'No Ice', 0, 3 UNION ALL
  SELECT 33, 'More Ice', 0, 1 UNION ALL
  SELECT 33, 'Less Ice', 0, 2 UNION ALL
  SELECT 33, 'No Ice', 0, 3 UNION ALL
  SELECT 35, 'More Ice', 0, 1 UNION ALL
  SELECT 35, 'Less Ice', 0, 2 UNION ALL
  SELECT 35, 'No Ice', 0, 3
) t;

-- Milk Choices (Items 14, 17 - milk tea only)
-- More Milk, Less Milk, No Milk
INSERT INTO customization_option_choices (option_id, choice_name, additional_cost, display_order)
SELECT option_id, choice_name, additional_cost, display_order
FROM (
  SELECT 27 AS option_id, 'More Milk' AS choice_name, 0 AS additional_cost, 1 AS display_order UNION ALL
  SELECT 27, 'Less Milk', 0, 2 UNION ALL
  SELECT 27, 'No Milk', 0, 3 UNION ALL
  SELECT 31, 'More Milk', 0, 1 UNION ALL
  SELECT 31, 'Less Milk', 0, 2 UNION ALL
  SELECT 31, 'No Milk', 0, 3
) t;

-- Toppings Choices (Item 11)
INSERT INTO customization_option_choices (option_id, choice_name, additional_cost, display_order)
SELECT option_id, choice_name, additional_cost, display_order
FROM (
  SELECT 21 AS option_id, 'Extra Sesame' AS choice_name, 0.50 AS additional_cost, 1 AS display_order UNION ALL
  SELECT 21, 'Peanuts', 0.50, 2 UNION ALL
  SELECT 21, 'Honey Drizzle', 1.00, 3 UNION ALL
  SELECT 21, 'Chocolate Chips', 1.00, 4
) t;
...
INSERT INTO table_orders (table_number, status) VALUES (1, 'available');
INSERT INTO table_orders (table_number, staff_id, status) VALUES (2, 1, 'reserved');
INSERT INTO table_orders (table_number, staff_id, status) VALUES (3, 2, 'seated');
INSERT INTO table_orders (table_number, oid, staff_id, status) VALUES (4, 1, 3, 'ordering');
INSERT INTO table_orders (table_number, oid, staff_id, status) VALUES (5, 2, 4, 'ready_to_pay');
INSERT INTO table_orders (table_number, oid, staff_id, status) VALUES (6, 2, 5, 'paid');
...
CREATE TABLE materials (
  ...
  mcategory VARCHAR(100) DEFAULT NULL,
